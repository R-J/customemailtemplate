...
<h1>Altered version</h1>
<h2>The source file can be found in the customEmailTemplate plugin folder</h2>
...
<!--[if (gte mso 9)|(IE)]>
        ...
        <![endif]-->
        {if $email.customEmailTemplate.countNotifications}
            <p>By the way: you have {$email.customEmailTemplate.countNotifications} unread notifications.</p>
        {/if}
        {if $email.footer}
        <!--[if (gte mso 9)|(IE)]>
        <table width="600" align="center" cellpadding="0" cellspacing="0" border="0">
